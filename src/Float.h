...
public:
    ...
    explicit _Float(bool value) { _value._raw = value ? (static_cast<value_type>(1) << BinaryExponent) : 0; }
    
    explicit _Float(int32_t i) { _value._raw = static_cast<value_type>(static_cast<int64_t>(i) << BinaryExponent); }
    ...
    _Float(value_type i, int32_t e)
    {
        ...
        if (e == 0) {
            _value._raw = static_cast<value_type>(static_cast<int64_t>(i) << BinaryExponent);
            return;
        }
